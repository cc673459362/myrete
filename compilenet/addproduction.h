...
/*
	...
	return ---> bool
*/
bool add_production(const boost::shared_ptr<rule> &rule,boost::shared_ptr<betamemory> &dummynode,boost::shared_ptr<alphanode> &root,std::vector<boost::shared_ptr<alphamemory> > &);
